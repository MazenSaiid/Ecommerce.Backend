        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductItemsOrdered_ProductItemId = table.Column<int>(type: "int", nullable: true),
                    ProductItemsOrdered_ProductItemName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProductItemsOrdered_ProductItemPicture = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "One Day", "Fastest Delivery Time", "DHL", 20m },
                    { 2, "3 Days", "Get it within 3 days", "Aramex", 10m },
                    { 3, "Five -Seven Days", "Slower but cheap", "Fedex", 5m },
                    { 4, "10 Days", "Free", "Jumia", 0m }
                });
